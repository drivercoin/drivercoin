...
###   This script attempts to download the signature file SHA256SUMS.asc from drivercoin.org
...
WORKINGDIR="/tmp/drivercoin"
TMPFILE="hashes.tmp"

#this URL is used if a version number is not specified as an argument to the script
SIGNATUREFILE="https://drivercoin.org/bin/0.9.2.1/SHA256SUMS.asc"

SIGNATUREFILENAME="SHA256SUMS.asc"
RCSUBDIR="test/"
BASEDIR="https://drivercoin.org/bin/"
VERSIONPREFIX="drivercoin-"
RCVERSIONSTRING="rc"
...
if [ -n "$1" ]; then
   #let's also check if the version number includes the prefix 'drivercoin-',
...
if [ $? -ne 0 ]; then
   ...
   echo "[drivercoin-]<version>-[rc[0-9]] (example: drivercoin-0.9.2-rc1)"
   echo "wget output:"
