Drivercoin-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/drivercoin/files/Drivercoin/drivercoin-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Drivercoin
...
New/changed settings (command-line or drivercoin.conf file)
--------------------------------------------------------
