Download URL: https://sourceforge.net/projects/drivercoin/files/Drivercoin/drivercoin-0.3.22/
...
Notable changes:
* Client will accept and relay TX's with 0.0005 DVR fee schedule (users still pay 0.01 DVR per kb, until next version)
...
* IRC is overflowing.  Client now bootstraps to channels #drivercoin00 - #drivercoin99
