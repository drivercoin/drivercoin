Drivercoin version 0.5.4 is now available for download at:
http://sourceforge.net/projects/drivercoin/files/Drivercoin/drivercoin-0.5.4/
...
http://gitorious.org/drivercoin/drivercoind-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Drivercoin-Qt notifications under Growl 1.3.
Increase required age of Drivercoin-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxDrivercoin properly when installing Drivercoin-Qt over it. (Windows)
