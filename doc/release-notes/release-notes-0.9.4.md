Drivercoin Core version 0.9.4 is now available from:

  https://drivercoin.org/bin/0.9.4/
...
this update is incompatible with the Drivercoin system and could lead to consensus
forks.

Drivercoin Core released binaries from https://drivercoin.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~drivercoin/+archive/ubuntu/drivercoin
- A third-party or self-compiled Drivercoin Core

upgrade to Drivercoin Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
