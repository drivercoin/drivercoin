Drivercoin Core version 0.9.2.1 is now available from:

  https://drivercoin.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 DVR to 0.01 DVR
...
- Fix "Start drivercoin on system login"
