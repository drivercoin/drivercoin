...
This document provides guidelines for internationalization of the Drivercoin Core software. 
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `drivercoin_en.ts` remains unchanged.
