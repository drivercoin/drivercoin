...
unlocked to sign the Drivercoin-Qt.app bundle.
...
allowing somebody to distribute a Drivercoin-Qt.app or drivercoin-qt-setup.exe with a valid
...
that the drivercoin-qt.exe file inside the installer had not been tampered with.
