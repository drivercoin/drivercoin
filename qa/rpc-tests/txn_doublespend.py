...
class TxnMallTest(DrivercoinTestFramework):
    ...
    def run_test(self):
        # All nodes should start with 1,250 DVR:
        ...
        # First: use raw transaction API to send 1240 DVR to node1_address,
        # but don't broadcast:
        ...
        # Create two spends using 1 50 DVR coin each
        ...
        # Node0's balance should be starting balance, plus 50DVR for another
        ...
        # Node0's total balance should be starting balance, plus 100DVR for 
