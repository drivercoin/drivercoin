...
{
    BOOST_CHECK(TestSplitHost("www.drivercoin.org", "www.drivercoin.org", -1));
    BOOST_CHECK(TestSplitHost("[www.drivercoin.org]", "www.drivercoin.org", -1));
    BOOST_CHECK(TestSplitHost("www.drivercoin.org:80", "www.drivercoin.org", 80));
    BOOST_CHECK(TestSplitHost("[www.drivercoin.org]:80", "www.drivercoin.org", 80));
    BOOST_CHECK(TestSplitHost("127.0.0.1", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("127.0.0.1:56790", "127.0.0.1", 56790));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]:56790", "127.0.0.1", 56790));
    BOOST_CHECK(TestSplitHost("::ffff:127.0.0.1", "::ffff:127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[::ffff:127.0.0.1]:56790", "::ffff:127.0.0.1", 56790));
    BOOST_CHECK(TestSplitHost("[::]:56790", "::", 56790));
    BOOST_CHECK(TestSplitHost("::56790", "::56790", -1));
    BOOST_CHECK(TestSplitHost(":56790", "", 56790));
    BOOST_CHECK(TestSplitHost("[]:56790", "", 56790));
...
BOOST_AUTO_TEST_CASE(netbase_lookupnumeric)
{
    ...
    BOOST_CHECK(TestParse("127.0.0.1:56790", "127.0.0.1:56790"));
    BOOST_CHECK(TestParse("::ffff:127.0.0.1", "127.0.0.1:65535"));
    BOOST_CHECK(TestParse("::", "[::]:65535"));
    BOOST_CHECK(TestParse("[::]:56790", "[::]:56790"));
    BOOST_CHECK(TestParse("[127.0.0.1]", "127.0.0.1:65535"));
