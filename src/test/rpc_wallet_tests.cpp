// Copyright (c) 2013-2014 The Drivercoin Core developers
...
BOOST_AUTO_TEST_CASE(rpc_wallet)
{
    ...
    UniValue r;
    CPubKey demoPubkey;
    CDrivercoinAddress demoAddress;
    UniValue retValue;
    string strAccount = "walletDemoAccount";
    CDrivercoinAddress setaccountDemoAddress;
    {
        LOCK(pwalletMain->cs_wallet);

        demoPubkey = pwalletMain->GenerateNewKey();
        demoAddress = CDrivercoinAddress(CTxDestination(demoPubkey.GetID()));
        ...
        setaccountDemoAddress = CDrivercoinAddress(CTxDestination(setaccountDemoPubkey.GetID()));
    }
    /*********************************
     * 			setaccount
     *********************************/
    ...
    BOOST_CHECK(CDrivercoinAddress(retValue.get_str()).Get() == demoAddress.Get());
    ...
    BOOST_CHECK(CDrivercoinAddress(arr[0].get_str()).Get() == demoAddress.Get());
