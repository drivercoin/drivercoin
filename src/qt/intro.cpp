...
void Intro::pickDataDirectory()
{
    ...
    if(!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false))
    {
        ...
        intro.setWindowIcon(QIcon(":icons/drivercoin"));
        ...
        while(true)
        {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Drivercoin Core"),
     ...
     * override -datadir in the drivercoin.conf file in the default data directory
     * (to be consistent with drivercoind behavior)
     */
    if(dataDir != getDefaultDataDirectory())
