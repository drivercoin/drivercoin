...
private:
    ...
    QString formatTxAmount(const TransactionRecord *wtx, bool showUnconfirmed=true, DrivercoinUnits::SeparatorStyle separators=DrivercoinUnits::separatorStandard) const;
